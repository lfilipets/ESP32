...
// Configuração da rede WiFi
   ...
   const char *ssid = "LFTS-TPLINK";     // Define o SSID (nome da rede)
   const char *password = "29011984"; // Define a PassWord
...
timeClient.update();
  ...
  lcd.clear();
  piscaSistemaOK(lcd, 3, 1000); // Pisca 5 vezes, 1000ms cada
